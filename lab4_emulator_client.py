...
certificate_formatter = "./keys/device{}.certificate.pem"
key_formatter = "./keys/device{}.private.pem"
...
class MQTTClient:
    def __init__(self, device_id, cert, key):
        ...
        self.client.configureEndpoint("a2nfcv2mpnifm9-ats.iot.us-east-1.amazonaws.com", 8883)
    ...
    def subscribe(self, topic="vehicle/emission/command"):
        self.client.subscribeAsync(
            topic,
            1,
            ackCallback=self.customSubackCallback
        )
